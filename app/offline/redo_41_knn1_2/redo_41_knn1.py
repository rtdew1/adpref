...
redone_test_df.loc[:,"model_version"] = "knn-k1-redo"
redone_test_df.to_csv(os.path.expanduser('~/ryandew_adaptive_preference/RA/results_analysis/redo_41_knn1_2/4-1_knn1_test_df.csv'), index=False)