...
APP_VERSION = "Binary MPC - MU on Different Representations"
OUTPUT_FILE = "mu_diff_reps_random_items"
IS_MPC = True
target_dir = os.path.expanduser("~/ryandew_adaptive_preference/RA/results_analysis/different_reps_offline_testing/7.x/outputs/")
train_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.0-knn1-binary-mpc-None/train_df.csv'))
test_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.0-knn1-binary-mpc-None/test_df.csv'))
ind_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.0-knn1-binary-mpc-None/individuals.csv'))


data_files = [
    os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/dresses10_urls.csv"),
    os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/scaled_dresses10_url-PCA-dimensions5.csv"),
    os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/scaled_dresses10_url-UMAP-dimensions5.csv"),
    os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/scaled_vgg_pca10_dresses.csv"),
    os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/scaled_vgg_pca20_dresses.csv"),
]

data_names = ["Original", "PCA-5", "UMAP-5", "VGG-PCA-10", "VGG-PCA-20"]
...
# We need the moments of the original data to rescale other datasets:
