...
APP_VERSION = "Binary MPC - Nearest Neighbor"
FILE_EXTENSION = "knn"
DATA_FILE = os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/dresses10_urls.csv")
IS_MPC = True
target_dir = os.path.expanduser("~/ryandew_adaptive_preference/RA/results_analysis/n_ratings_offline_testing/7.x_acc/knn/")
