...
APP_VERSION = "Binary MPC - Adaptive Linear"
FILE_EXTENSION = "abernethy"
DATA_FILE = os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/dresses10_urls.csv")
IS_MPC = True
target_dir = os.path.expanduser("~/ryandew_adaptive_preference/RA/results_analysis/n_ratings_offline_testing/7.x_acc/abernethy/")
train_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.1.2-abernethy-binary-mpc-None/train_df.csv'))
test_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.1.2-abernethy-binary-mpc-None/test_df.csv'))
ind_df = pd.read_csv(os.path.expanduser('~/Dropbox/1_proj/urbn/results/binary_mpc_results/analysis-7.1.2-abernethy-binary-mpc-None/individuals.csv'))
