...
APP_VERSION = "Binary MPC - MU-Agg on Random"
FILE_EXTENSION = "mu-agg_on_knn"
DATA_FILE = os.path.expanduser("~/ryandew_adaptive_preference/RA/backend/data/dresses10_urls.csv")
IS_MPC = True
target_dir = os.path.expanduser("~/ryandew_adaptive_preference/RA/results_analysis/n_ratings_offline_testing/7.x_benefits_of_adaptivity/mu-agg_on_knn")
