...
import mpcCheckboxImage from '../../assets/mpc-checkbox.png';
        ...
        <div>
          ...
          <div className="home-page-text">
            ...
            using the following scale:
              ...
              <img src={mpcCheckboxImage} width='75%' style={{border: "1px solid black", marginTop: "25px", marginBottom: "10px"}} alt='screenshot of rating scale'/> <br />
            <p>
